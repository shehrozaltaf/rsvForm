$(function () {
    altair_datatables.dt_default(), altair_datatables.dt_scroll(), altair_datatables.dt_individual_search(), altair_datatables.dt_colVis(),
    ...
    dt_default: function () {
        ...
        var t = $("#dt_colVis"), a = $(".dt_colVis_buttons");
        t.length && t.DataTable({buttons: [{extend: "colvis", fade: 0}]}).buttons().container().appendTo(a)
    }, dt_tableExport: function (myid) {
        var id = 'dt_tableExport';
        ...
        var t = $("#" + id), a = $(".dt_colVis_buttons");
        t.length && (t.find("thead th").each(function () {
            var a = t.find("thead th").eq($(this).index()).text();
            $(this).html('<input type="text" class="md-input" placeholder="' + a + '" />')
        }), altair_md.inputs(), t.DataTable({
            buttons: [{
                extend: "copyHtml5",
