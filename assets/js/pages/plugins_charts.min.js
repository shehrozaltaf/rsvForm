$(function () {
    ...
    metrics_graphics: function () {
        var e = "#mg_chart_linked_a", t = "#mg_chart_linked_b", n = $(e).height(), a = $(t).height();
        if ($(e).length && $(t).length) {
            function i() {
                var i = $(e).width(), o = $(t).width();
                d3.json("data/mg_brief-1.min.json").then(function (t) {
        ...
        var o = "#mg_chart_confidence_band", r = $(o).height();
        if ($(o).length) {
            function s() {
                var e = $(o).width();
                d3.json("data/mg_confidence_band.min.json").then(function (t) {
                    t = MG.convert.date(t, "date"), MG.data_graphic({
            ...
            s(), $window.on("debouncedresize", function () {
                s()
            })
        }
        var d = "#mg_chart_currency", c = $(o).height();
        if ($(d).length) {
            function l() {
                var e = $(o).width();
                d3.json("data/mg_some_currency.min.json").then(function (t) {
                    t = MG.convert.date(t, "date"), MG.data_graphic({
                        title: "Some Currency",
            ...
            $(e).waypoint({
                handler: function () {
                    setTimeout(function () {
                        ...
                        t.groups([["data1", "data2", "data3", "data4"]])
                    }, 2e3), this.destroy()
                }, offset: "80%"
            ...
            $(s).waypoint({
                handler: function () {
                    setTimeout(function () {
                        ...
                        d.load({columns: [["virginica", .2, .2, .2, .2, .2, .4, .3, .2, .2, .1, .2, .2, .1, .1, .2, .4, .4, .3, .3, .3, .2, .4, .2, .5, .2, .2, .4, .2, .2, .2, .2, .4, .1, .2, .2, .2, .2, .1, .2, .2, .3, .3, .2, .6, .4, .3, .2, .2, .2, .2]]})
                    }, 3e3), this.destroy()
                }, offset: "80%"
            }), $window.on("debouncedresize", function () {
                d.resize()
